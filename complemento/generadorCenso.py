...
for i in range(250):  # Generar 100 registros
    ...
    censo.append([
        identificacion, nombre, apellido1, apellido2, tipo_documento, numeroC, correo, "", facultad, programa, semestre,
...
with open('censoGen.csv', 'w', newline='', encoding='utf-8') as file:
    ...
    writer.writerow([
        "identificacion", "nombre", "apellido1", "apellido2", "tipo_documento", "numero_celular", "correo", "billetera",  "facultad", "programa", "sem",
